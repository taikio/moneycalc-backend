...
var NewBillValidationSchema = joi_1.default.object().keys({
    ...
    destiny: joi_1.default.string().required().error(function () { return new Error('Informe o destino do lançamento financeiro'); })
});
exports.default = NewBillValidationSchema;
//# sourceMappingURL=newBillValidationSchema.js.map